...
export default function InstitutionalAgentTickets() {
  const { user } = useAuth();
  ...
  // First get the org's agent IDs, then fetch their tickets
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Carbon offset tickets from your travel agents</p>
      </div>
