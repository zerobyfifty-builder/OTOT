...
interface Props {
  ...
  /** When provided, sheet opens directly on the starter step for that category. */
  initialCategory?: CategoryKey | null;
}

export default function NewTemplateSheet({ open, onClose, onCreated, initialCategory }: Props) {
  ...
  return (
    <Sheet open={open} onOpenChange={(o) => !o && close()}>
      <SheetContent side="right" className="w-full sm:max-w-2xl overflow-y-auto p-0 flex flex-col">
        <SheetHeader className="px-5 py-3 border-b text-left space-y-0">
