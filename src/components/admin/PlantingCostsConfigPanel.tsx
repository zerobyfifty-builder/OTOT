            ...
            {isViable ? (
              <div className="p-4 rounded-lg bg-emerald-50 border border-emerald-200">
                <div className="flex items-center gap-2">
                  ...
                  <p className="font-medium text-emerald-800 text-sm">MoE receives {formatUSD(moeUSD)}, covering the cost KES {formatKES(totalKES)} ({formatUSD(moeNeedUSD)}). Surplus {formatUSD(surplus)} added to MoE reserve.</p>
                </div>
              </div>
            ) : (
