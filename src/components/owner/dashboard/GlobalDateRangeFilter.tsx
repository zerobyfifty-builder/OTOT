...
export const GlobalDateRangeFilter: React.FC<Props> = ({ range, onPreset, onCustom }) => {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <button
          className="inline-flex items-center gap-2 rounded-full border border-border bg-card px-3.5 py-1.5 text-[12px] font-medium text-foreground shadow-[0_1px_2px_rgba(16,24,40,0.04)] hover:bg-muted/60 transition-colors"
        >
