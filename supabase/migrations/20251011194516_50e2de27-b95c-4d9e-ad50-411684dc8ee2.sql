-- Step 1: Enhanced Database Schema with Multi-Tenant Architecture (Fixed)
...
-- RLS Policies for partner_types
...
-- Create trigger for updating updated_at on organizations
...
-- Create trigger for updating updated_at on roles
CREATE TRIGGER trigger_update_roles_updated_at
  BEFORE UPDATE ON public.roles
  FOR EACH ROW
  EXECUTE FUNCTION public.update_updated_at_column();

-- Seed initial data: Default Roles
...
-- Seed initial data: Partner Types
...
-- Seed initial data: Core Modules
...
-- Seed module permissions (fixed ambiguous column reference)
